...
public interface TabuList extends java.io.Serializable
{
     ...
     * @since 1.0
     */
    public abstract void setTabu( Solution fromSolution, Move move, int iteration );
     ...
     * @since 1.0
     */
    public abstract boolean isTabu( Solution fromSolution, Move move, int iteration );
